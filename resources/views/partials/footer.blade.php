<footer class="bg-black w-full text-white py-2 lg:px-20 md:px-20 border-t">
    <div class="container mx-auto px-4 grid grid-cols-3 items-center">
        <!-- Left: Social Media -->
        <div class="grid grid-cols-2 gap-2 gap-x-10 max-w-10 items-center">
            <!-- Discord -->
            <a href="#" title="Discord" aria-label="Discord" target="_blank" class="hover:scale-110 transition-transform">
            ...
            <!-- TikTok -->
            <a href="#" aria-label="TikTok" title="Tiktok" target="_blank" class="hover:scale-110 transition-transform">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-current" viewBox="0 0 24 24">
                    <path
            ...
            <!-- Instagram -->
            <a href="#" aria-label="Instagram" title="Instagram" target="_blank" class="hover:scale-110 transition-transform">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-current" viewBox="0 0 24 24">
                    <path
            ...
            <a href="" title="Voting" class="hover:scale-110 mt-1">
                <i class="fa-solid fa-vote-yea"></i>
            </a>
        </div>

        <!-- Center: Vote Button -->
        <div class="flex justify-center relative text-blue-500 font-bold sm:text-50 md:text-2xl p-2">
            <p>mc.holybone.id</p>
        </div>

        <!-- Right: Copyright -->
        <div class="flex justify-end text-sm opacity-80">
            <p class="ml-10">&copy; {{ date('Y') }} HolyBone</p>
        </div>
    </div>
</footer>